...
public class ProductImagesAdapter extends RecyclerView.Adapter<ProductImagesAdapter.ViewHolder>  {
    ...
    List<ProductDetails.product.ProductphotosBean> productphotos;
    public  int mSelectedItem = 0 ;
    ProductDetailsFragment fragment ;
    public ProductImagesAdapter(Context mcontext, List<ProductDetails.product.ProductphotosBean> productphotos1,
